...
void hex_dump(int16_t input_buffer[])
{
	...
	for(i = 100; i >= 0; i-=4) {
		...
		switch(digit) {
			case 0: debug_print("0"); break;
			case 1: debug_print("1"); break;
			case 2: debug_print("2"); break;
			case 3: debug_print("3"); break;
			case 4: debug_print("4"); break;
			case 5: debug_print("5"); break;
			case 6: debug_print("6"); break;
			case 7: debug_print("7"); break;
			case 8: debug_print("8"); break;
			case 9: debug_print("9"); break;
			case 10: debug_print("A"); break;
			case 11: debug_print("B"); break;
			case 12: debug_print("C"); break;
			case 13: debug_print("D"); break;
			case 14: debug_print("E"); break;
			case 15: debug_print("F"); break;
		}
		if(byte_space == 1) {
			byte_space = 0;
		} else {
